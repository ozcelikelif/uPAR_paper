...
correlation_data <- correlation_data %>%
  mutate(
    Var1 = recode(Var1, "Mixed_upar." = "uPAR+Mixed", "uparCAF" = "uPAR+CAF", "UPAR.MacroMono" = "uPAR+Myeloid","UPARrelated" = "uPAR+Cycling"),
    Var2 = recode(Var2, "Mixed_upar." = "uPAR+Mixed", "uparCAF" = "uPAR+CAF", "UPAR.MacroMono" = "uPAR+Myeloid","UPARrelated" = "uPAR+Cycling")
  )
